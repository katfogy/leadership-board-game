...
- **[Sync Javascript is used with API's]**
...
```sh
  cd my-folder
  git clone git@github.com:katfogy/leadership-board-game.git
```
-
...
Feel free to check the [issues page](https://github.com/katfogy/leadership-board-game/issues).
